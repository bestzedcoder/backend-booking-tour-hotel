...
public class JwtValidationFilter extends OncePerRequestFilter {
  ...
  protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
    ...
    return requestURI.contains("/register") || requestURI.contains("/login") || requestURI.contains("/verify") || requestURI.contains("/refresh") || requestURI.contains("/swagger-ui") || requestURI.contains("/v3/api-docs") || requestURI.contains("/vn-pay-callback");
  }
}
